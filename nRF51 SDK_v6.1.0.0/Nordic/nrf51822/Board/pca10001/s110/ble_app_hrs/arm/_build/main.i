...
{
    do { app_error_handler((nrf_error), 168, (uint8_t*) "..\\main.c"); } while (0);
}
...
static void heart_rate_meas_timeout_handler(void * p_context)
{
    ...
    {
        do { app_error_handler((err_code), 219, (uint8_t*) "..\\main.c"); } while (0);
    }
}
    ...
    if (button_action == 1)
    {
        switch (pin_no)
        {
            ...
            case 17:
                ...
                m_cur_heart_rate -= 2;
                if (m_cur_heart_rate < 60)
                {
                    m_cur_heart_rate = 300; 
                }
                break;
                
            default:
                do { app_error_handler((pin_no), 253, (uint8_t*) "..\\main.c"); } while (0);
                break;
        }
    }    
}
...
static void timers_init(void)
{
    ...
    do { static uint32_t APP_TIMER_BUF[((((( (((5)) * 40) + ( 3 * (8 + (((5) + 1) + 1) * 24) ) )) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_timer_init((0), (5), (5) + 1, APP_TIMER_BUF, (0) ? app_timer_evt_schedule : 0); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 273, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);

    
    err_code = app_timer_create(&m_battery_timer_id,
                                APP_TIMER_MODE_REPEATED,
                                battery_level_meas_timeout_handler);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 279, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

    err_code = app_timer_create(&m_heart_rate_timer_id,
                                APP_TIMER_MODE_REPEATED,
                                heart_rate_meas_timeout_handler);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 284, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void gap_params_init(void)
{
    ...
    err_code = sd_ble_gap_device_name_set(&sec_mode,
                                          ...
                                          strlen("Nordic_HRM"));
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 304, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

    err_code = sd_ble_gap_appearance_set(833);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 307, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 317, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void services_init(void)
{
    ...
    hrs_init.is_sensor_contact_supported = 0;
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 410, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
...
static void conn_params_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 446, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static uint32_t device_manager_evt_handler(dm_handle_t const    * p_handle,
                                           ...
                                           api_result_t           event_result)
{
    do { const uint32_t LOCAL_ERR_CODE = (event_result); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 458, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    return ((0x0) + 0);
}
...
static void device_manager_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 473, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

    
    init_data.clear_persistent_data = (nrf_gpio_pin_read(17) == 0);
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 494, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void ble_stack_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 518, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
...
{
    do { static uint32_t app_gpiote_buf[((((((1) * 20)) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_gpiote_init((1), app_gpiote_buf); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 530, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);
}
...
static void buttons_init(void)
{
    ...
    do { uint32_t ERR_CODE = app_button_init((buttons), (sizeof(buttons) / sizeof(buttons[0])), (((uint32_t)((((50) * (uint64_t)32768) + ((((0) + 1) * 1000) / 2)) / (((0) + 1) * 1000)))), (0) ? app_button_evt_schedule : 0); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 547, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);
}
...
static void application_timers_start(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 566, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void advertising_start(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 577, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
...
static void system_off_mode_enter(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 593, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 602, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
int main(void)
{
    ...
    for (;;)
    {
        ...
        do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 753, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    }
}
