...
static pstorage_module_table_t m_app_table[1];  
...
static void cmd_queue_element_init(uint32_t index)
{
    ...
    m_cmd_queue.cmd[index].storage_addr.module_id = 1;
    ...
    switch (p_cmd->op_code)
    {
        ...
        case 0x04:
        {
            ...
            if (((base_address == storage_addr) && (block_size * block_count == p_cmd->size)) ||
                (p_cmd->storage_addr.module_id == (1 + 1)))
            {
...
uint32_t pstorage_init(void)
{
    ...
    m_next_page_addr    = ((((((NRF_UICR_Type *) 0x10001000UL)->BOOTLOADERADDR != 0xFFFFFFFF) ? (((NRF_UICR_Type *) 0x10001000UL)->BOOTLOADERADDR / ((uint16_t)((NRF_FICR_Type *) 0x10000000UL)->CODEPAGESIZE)) : ((NRF_FICR_Type *) 0x10000000UL)->CODESIZE) - 1 - 1) * ((uint16_t)((NRF_FICR_Type *) 0x10000000UL)->CODEPAGESIZE));
    m_round_val         = 0;
                                       ...
                                       pstorage_handle_t * p_block_id)
{
    ...
    if ((p_block_id) == 0) { return ((0x0) + 14); };
    if ((((p_base_id)->module_id) >= 1) || (m_app_table[(p_base_id)->module_id]. cb == 0)) { return ((0x0) + 7); };
                        ...
                        pstorage_size_t     offset)
{
    ...
    if ((((p_dest)->module_id) >= 1) || (m_app_table[(p_dest)->module_id]. cb == 0)) { return ((0x0) + 7); };
                       ...
                       pstorage_size_t     offset)
{
    ...
    if ((p_src) == 0) { return ((0x0) + 14); };
    if ((p_dest) == 0) { return ((0x0) + 14); };
    if ((((p_src)->module_id) >= 1) || (m_app_table[(p_src)->module_id]. cb == 0)) { return ((0x0) + 7); };
