...
{
    if (((NRF_ADC_Type *) 0x40007000UL)->EVENTS_END != 0)
    {
        uint8_t     adc_result;
        ...
        batt_lvl_in_milli_volts = ((((adc_result) * 1200) / 255) * 3) +
                                  270;
        ...
        {
            do { app_error_handler((err_code), 83, (uint8_t*) "..\\battery.c"); } while (0);
        }
    }
}
...
void battery_start(void)
{
    ...
    ((NRF_ADC_Type *) 0x40007000UL)->INTENSET   = (0x1UL << (0UL));
    ((NRF_ADC_Type *) 0x40007000UL)->CONFIG     = ((0x00UL)                        << (0UL))     |
                          ((0x06UL) << (2UL))  |
                          ((0x00UL)                      << (5UL))  |
                          ((0UL)                   << (8UL))    |
                          ((0UL)                  << (16UL));
    ((NRF_ADC_Type *) 0x40007000UL)->EVENTS_END = 0;
    ((NRF_ADC_Type *) 0x40007000UL)->ENABLE     = (0x01UL);

    
    err_code = sd_nvic_ClearPendingIRQ(ADC_IRQn);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 105, (uint8_t*) "..\\battery.c"); } while (0); } } while (0);

    err_code = sd_nvic_SetPriority(ADC_IRQn, NRF_APP_PRIORITY_LOW);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 108, (uint8_t*) "..\\battery.c"); } while (0); } } while (0);

    err_code = sd_nvic_EnableIRQ(ADC_IRQn);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 111, (uint8_t*) "..\\battery.c"); } while (0); } } while (0);
