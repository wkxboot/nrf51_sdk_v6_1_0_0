...
static void timer1_init(void)
{
    ...
    ((NRF_TIMER_Type *) 0x40009000UL)->BITMODE   = (0x00UL);
    ((NRF_TIMER_Type *) 0x40009000UL)->PRESCALER = 9;
    ...
    ((NRF_TIMER_Type *) 0x40009000UL)->CC[0] = 0x1E84;

    
    ((NRF_TIMER_Type *) 0x40009000UL)->SHORTS = (1UL) << (0UL);
...
static void ppi_init(void)
{
    ...
    err_code = sd_ppi_channel_assign(0,
                                     &(((NRF_TIMER_Type *) 0x40009000UL)->EVENTS_COMPARE[0]),
                                     &(((NRF_GPIOTE_Type *) 0x40006000UL)->TASKS_OUT[3]));
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 85, (uint8_t*) "..\\led.c"); } while (0); } } while (0);

    
    err_code = sd_ppi_channel_enable_set((0x1UL << (0UL)));
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 89, (uint8_t*) "..\\led.c"); } while (0); } } while (0);
}
...
void led_stop(void)
{
    ...
    ((NRF_GPIOTE_Type *) 0x40006000UL)->CONFIG[3] =
                                          ((0x00UL) << (0UL));
