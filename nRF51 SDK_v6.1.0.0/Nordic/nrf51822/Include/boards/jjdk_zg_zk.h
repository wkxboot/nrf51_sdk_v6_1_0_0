...
// LEDs definitions for JJDK_ZG_ZK board 引脚定义
#define LEDS_NUMBER             3
#define LED_START_PIN_NO               7
#define LED_NEGATIVE_ION_PIN_NO        7//     7 //风扇和负离子指示灯
#define LED_UV_LAMP_PIN_NO             8//     8 //紫外消毒指示灯
#define LED_SYS_RUN_PIN_NO            12//     12//运行灯
#define LED_STOP_PIN_NO               12 
...
#define SWITCH_START_PIN_NO             1
#define SWITCH_1_PIN_NO                 1  
#define SWITCH_UV_LAMP_PIN_NO           6//  6 紫外线灯开关
#define SWITCH_FAN_NEGATIVE_ION_PIN_NO  7//  7 风扇和负氧离子开关
#define SWITCH_ELEC_LOCK_PIN_NO         11// 11电磁锁开关
#define SWITCH_STOP_PIN_NO              11
...
#define BUTTON_START_PIN_NO            2
#define BUTTON_ELEC_LOCK_PIN_NO        2
#define BUTTON_UV_LAMP_DOOR_PIN_NO     3
#define BUTTON_COIN_BOX_PIN_NO         4
#define BUTTON_STOP_PIN_NO             4
...
#define TX_PIN_NUMBER  24//30=ddb rx
